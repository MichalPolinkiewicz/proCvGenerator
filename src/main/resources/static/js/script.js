function addEducationRow() {
    if (document.readyState === 'complete') {
        ...
        if (i < max) {
            ...
            newCell6.innerHTML = '<td><button type="button" onclick="deleteRow(\'' + tableId + '\', \'' + elementId + '\', \'\'+2+\'\' )"/>Usuń</td>'
        } else {
...
function addEmploymentRow() {
    if (document.readyState === 'complete') {
        ...
        if (i < max) {
            ...
            newCell1.innerHTML = '<td> <input id="employmentListWrapperDto.employmentList' + i + '.company" name="employmentListWrapperDto.employmentList[' + i + '].company" required></td>';
            newCell2.innerHTML = '<td> <input id="employmentListWrapperDto.employmentList' + i + '.position" name="employmentListWrapperDto.employmentList[' + i + '].position" required></td>';
            newCell3.innerHTML = '<td> <input id="employmentListWrapperDto.employmentList' + i + '.jobDescription" name="employmentListWrapperDto.employmentList[' + i + '].jobDescription" required></td>';
            newCell4.innerHTML = '<td> <input id="employmentListWrapperDto.employmentList' + i + '.startDate" name="employmentListWrapperDto.employmentList[' + i + '].startDate" required></td>';
            newCell5.innerHTML = '<td> <input id="employmentListWrapperDto.employmentList' + i + '.endDate" name="employmentListWrapperDto.employmentList[' + i + '].endDate" required></td>';
            newCell6.innerHTML = '<td><button type="button" onclick="deleteRow(\'' + tableId + '\',\'' + elementId + '\',\'' + 2 + '\')"/>Usuń</td>'
        } else {
            window.alert("Max value for this section is 5")
...
function addSkill() {
    if (document.readyState === 'complete') {
        ...
        if (i < 6) {
            newRow.innerHTML = '<tr><td><input id="skillsListWrapperDto.skills' + i + '" name="skillsListWrapperDto.skills[' + i + ']" size="50" required> <button type="button" onclick="deleteRow(\'' + tableId + '\', \'' + elementId + '\', \'' + 1 + '\')"/>Usuń</td></tr>';
        } else {
...
function addHobby() {
    if (document.readyState === 'complete') {
        ...
        if (i < 6) {
            newCell.innerHTML = '<tr><td><input id="hobbiesListWrapperDto.hobbyList' + i + '" name="hobbiesListWrapperDto.hobbyList[' + i + ']" required> <button type="button" onclick="deleteRow(\'' + tableId + '\', \'' + elementId + '\', \'' + 1 + '\')"/>Usuń</td></tr>';
        } else {
            window.alert("Max value for this section is 6")
